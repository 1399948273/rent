/*
 ...
 Source Schema         : new_ssm

 Target Server Type    : MySQL
 Target Server Version : 50727
 File Encoding         : 65001

 Date: 17/10/2019 17:03:04
*/
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '访问权限表' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_access_permission_test` VALUES ('211524ebe0d247d89340c8e69537e5b6', 'demo/*', 'authc,roleOr[test,admin]', 831, NULL, 'hourse', NULL, NULL, NULL);
...
INSERT INTO `sys_access_permission_test` VALUES ('98b16028888a4b2cac421297847e53a9', 'userdemo/*', 'authc,roleOr[test,admin]', 943, NULL, 'hourse', NULL, NULL, NULL);
...
-- ----------------------------
INSERT INTO `sys_menu_role_test` VALUES ('03354da15dd148cd9ed49a1f79d85be7', '61fe856dec43470895afa1196db1ed77', 'J/F9-+?', NULL, NULL, NULL, NULL);
...
INSERT INTO `sys_menu_role_test` VALUES ('82c3dbd3a09b4903ad36eda714a61d58', '3e0327815cc544e280d2eb97c026058d', '343859934ece44c988f53700fb34c80a', NULL, NULL, NULL, NULL);
...
INSERT INTO `sys_menu_role_test` VALUES ('959bbe9a67f34bf69f896f9771b3e15f', '61fe856dec43470895afa1196db1ed77', '343859934ece44c988f53700fb34c80a', NULL, NULL, NULL, NULL);
...
INSERT INTO `sys_menu_role_test` VALUES ('b3c934fc452940978cf84df2b8879ad4', '3e0327815cc544e280d2eb97c026058d', 'J/F9-+?', NULL, NULL, NULL, NULL);
...
INSERT INTO `sys_menu_test` VALUES ('3e0327815cc544e280d2eb97c026058d', '用户管理', 'page/system/userdemo/allUsers.html', 'userdemo/*', 'icon-text', '2-1', NULL, '61fe856dec43470895afa1196db1ed77', 1, 'hourse', '2019-10-17 16:14:53', NULL, '2019-10-17 16:14:53');
...
INSERT INTO `sys_menu_test` VALUES ('61fe856dec43470895afa1196db1ed77', '测试菜单', '#', 'demo/*', 'icon-text', '2', NULL, NULL, 2, 'hourse', '2019-10-17 16:00:10', NULL, '2019-10-17 16:00:10');
...
CREATE TABLE `sys_oper_log_test`  (
  ...
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '应用日志表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户测试表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of user_test
-- ----------------------------
INSERT INTO `user_test` VALUES ('123', 'hourse', '7C4A8D09CA3762AF61E59520943DC26494F8941B', 'leiyao', '0', '13618629441', NULL, 'gameloft9', '总公司', '2019-10-17 15:24:31', '2019-10-17 15:24:31');
...
-- Records of userdemo
-- ----------------------------
INSERT INTO `userdemo` VALUES (1, '益达', '男', 19);
INSERT INTO `userdemo` VALUES (2, '益达', '男', 19);
INSERT INTO `userdemo` VALUES (3, 'da', '男', 18);

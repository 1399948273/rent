...
layui.define(['$tool','jquery'], function (exports) {
    ...
    var API = {
        ...
        DeleteUserDemo:function(req,config,successCallback,errorCallback){
            doPost($tool.getContext() + 'userdemo/deleteUserDemo.do',req,config,successCallback,errorCallback);
        },
        FindUserDemo:function(req,successCallback,errorCallback){
            doPost($tool.getContext() + 'userdemo/findById.do',req,successCallback,errorCallback);
        },
        UpdateUserDemo:function(req,config,successCallback,errorCallback){
            doComplexPost($tool.getContext() + 'userdemo/updateUserDemo.do',req,config,successCallback,errorCallback);
        },
        AddUserDemo:function(req,config,successCallback,errorCallback){
            doComplexPost($tool.getContext() + 'userdemo/addUserDemo.do',req,config,successCallback,errorCallback);
        },
    };
